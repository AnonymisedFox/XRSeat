...
This repository contains **all the parts, files, and components required for the fabrication and assembly of the XRSeat prototype**.
Every element has been included to ensure a complete understanding of the structure, the interactions between parts, and the overall system behavior.


## Introduction: what is XRSeat?
...
The current repo, anonymised for the submission of the paper, contains:
...
All design files are **also provided in native SolidWorks format**, ensuring full parametric access, editability, and compatibility with SolidWorks-based workflows.



## Known issues
Currently, the POÄNG chair chair model is **not** provided in STEP format.
This results in:
* limited parametric editing,
* constraints when integrating the model into certain CAD software,
